...
import { socialHandles, teamMembers } from '../../data'
    ...
    <section id='team'>
        <div className="container">
            <div className="section__header">
                ...
                <Link to='contact' className='flex__center btn primary'>Lets Talk Now <FaArrowRight /></Link>
            </div>
            <div>
                <Swiper 
                grabCursor={true}
                            ...
                            <div className="flex__center social__container">
                                {
                                    member.socialMedias.map((social,index) => (
                                        <a href={social.href} target='_blank' className='flex__center icon' key={index}>{social.icon}</a>
                                    ))
                                }
                            </div>
                        </SwiperSlide>
